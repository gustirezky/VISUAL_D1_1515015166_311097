...
public class inputKTP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rbWNA.setFont(new java.awt.Font("Times New Roman", 0, 11)); // NOI18N
        rbWNA.setText("WNA");

        buttonGroup2.add(rbWNI);
        rbWNI.setFont(new java.awt.Font("Times New Roman", 0, 11)); // NOI18N
        rbWNI.setText("WNI");

        jLabel8.setFont(new java.awt.Font("Times New Roman", 0, 11)); // NOI18N
        jLabel8.setText("Pilih Foto (3x4)");

        cus.setText("Pilih Foto");
...
//        outputKTP.setVisible(true);
    }//GEN-LAST:event_registerMouseClicked
    
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        outputKTP tampil = new outputKTP();
        outputKTP.namaout.setText(this.teksnama.getText());
        outputKTP.tempatout.setText(this.tekstempat.getText());
        
        outputKTP.tanggalout.setText(this.tekstanggal.getText());
        outputKTP.alamatout.setText(this.teksalamat.getText());
        outputKTP.rtout.setText(this.teksrt.getText());
        outputKTP.tfRW1.setText(this.teksrw.getText());
        outputKTP.kelout.setText(this.tekskel.getText());
        outputKTP.kecout.setText(this.tekskec.getText());
        outputKTP.kotaout.setText(this.tekskota.getText());
        outputKTP.agamaout.setText(this.boxagama.getSelectedItem().toString());
        outputKTP.statusout.setText(this.boxstatus.getSelectedItem().toString());
        outputKTP.goldarout.setText(this.boxgoldar.getSelectedItem().toString());
        outputKTP.pekerjaanout.setText(this.tekspekerjaan.getText());
        
        if(rbLaki.isSelected()){
            outputKTP.tfJK1.setText(rbLaki.getText());
        }
        else if(rbPerempuan.isSelected()){
            outputKTP.tfJK1.setText(rbPerempuan.getText());
        }
        if(rbWNA.isSelected()){
            outputKTP.wargaout.setText(rbWNA.getText());
        }
        
        else if(rbWNI.isSelected()){
            outputKTP.wargaout.setText(rbWNI.getText());
        }
        
        outputKTP.lFoto1.setIcon(this.lFoto.getIcon());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inputKTP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
